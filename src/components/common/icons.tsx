...
/**
 * 공통 라인 아이콘. stroke=currentColor 라 부모의 color로 색이 정해지고, size로 크기를 조절한다.
 * 이미지 파일 없이 SVG로 렌더 — 선명하고 색/크기 자유.
 */
...
/** 문서 분석(문서 + 돋보기) */
export function DocSearchIcon(props: IconProps) {
  return (
    <Svg {...props}>
